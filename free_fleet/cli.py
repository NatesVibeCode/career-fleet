"""Human and machine CLI for the SQLite-backed free-fleet control plane."""
...
def cmd_setup(args: argparse.Namespace) -> None:
    ...
    _emit(
        report,
        args.json,
        f"Configured free-fleet at {report.skill_path}.\n"
...
def _common(parser: argparse.ArgumentParser, *, json_output: bool = True, database: bool = True) -> None:
    if database:
        parser.add_argument("--db", help="SQLite control-plane path (default: ./free-fleet.db)")
    if json_output:
