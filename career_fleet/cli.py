...
def main():
    ...
    p_disc.add_argument("--max", type=int, default=50, help="Maximum items to ingest")
    ...
    p_trig.add_argument("--profile", default="profile.json", help="Path to profile.json")
    ...
    p_rec.add_argument("--profile", default="profile.json", help="Path to profile.json")
